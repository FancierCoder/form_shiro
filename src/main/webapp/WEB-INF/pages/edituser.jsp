    ...
    <div class="form-horizontal">
        <div class="row ">
            ...
            <div class="form-group col-sm-6">
                ...
                <div class="col-sm-8">
                    <select type="text" id="utype" class="form-control">
                        <option value=1 <c:if test="${selectUser.utype eq 1}">selected</c:if>>普通用户</option>
                        <option value=2 <c:if test="${selectUser.utype eq 2}">selected</c:if>>管理员</option>
                    </select>
                </div>
            </div>
        </div>
            ...
            if (state < -1) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        ustate: state, upoint: point, utype: type
                    },
