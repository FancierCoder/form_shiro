...
<div id="wrapper">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                        ...
                        <c:if test="${sectionvos!=null && fn:length(sectionvos)!=0}">
                            <c:forEach items="${sectionvos}" var="sectionvo">
                                <c:if test="${sectionvo.sparentname=='0'}">
                                    ...
                                    <li>
                                        <a class="J_menuItem"
                                           href="${staticPath}/show/topicCatalog?sid=${sectionvo.sections[0].sid}&&page=1">
                                                <c:if test="${1==maxsid}">
                                                    <span class="label label-danger pull-right">推荐</span>
                                                </c:if>
                                                ${sectionvo.sections[0].sname}
                                        </a>
                                    </li>
                ...
                <c:if test="${sessionScope.user!=null}">
                    ...
                    <%--私信--%>
                    <li>
                        <a class="J_menuItem" href="${staticPath}/tosixin" id="sixin">
                            <i class="fa fa-edit"></i>
                            <span class="nav-label">私信聊天</span></a>
                    </li>
                </c:if>
            </ul>
        </div>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe id="J_iframe" width="99%" height="99%" scrolling="auto" src="${staticPath}/section/toCatalog" frameborder="0" seamless>
