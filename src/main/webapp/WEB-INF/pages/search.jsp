                ...
                <div class="panel-body">
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-default">
                            ...
                            <div id="collapseOne" class="panel-collapse collapse <c:if test="${userlist==null || fn:length(userlist)==0}">in</c:if>">
                                <div class="panel-body">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseTwo" class="panel-collapse collapse  <c:if test="${topiclist!=null && fn:length(topiclist) !=0}">in</c:if> ">
                                <div class="panel-body">
